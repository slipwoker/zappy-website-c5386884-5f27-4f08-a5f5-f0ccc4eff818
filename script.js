  ...
  if (contactForm) {
    ...
    function getErrorContainer(field) {
      ...
      return field.parentElement
        ? field.parentElement.querySelector('.field-error, [data-error]')
        : null;
    }
    ...
    function validateField(field) {
      ...
      const label = field.getAttribute('aria-label')
        || (field.getAttribute('id')
          ? (contactForm.querySelector('label[for="' + field.getAttribute('id') + '"]') || {}).textContent
          : null)
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Attempt native form submission or fetch
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkVisibilityFallback() {
        ...
        animatableElements.forEach(function (el) {
          ...
          if (scrollY + windowHeight - 60 >= elementTop) {
            el.classList.add(VISIBLE_CLASS);
          }
        });
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "איריס נדרזון חוטה האתר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c5386884-5f27-4f08-a5f5-f0ccc4eff818',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c5386884-5f27-4f08-a5f5-f0ccc4eff818';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c5386884-5f27-4f08-a5f5-f0ccc4eff818';
